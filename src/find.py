...
def execute(csv_files, columns, finders, output='result'):
	data = None
	result = {}
...
if __name__ == "__main__":
	csv_files = ['youtube_data/GB_videos_5p.csv', 'youtube_data/US_videos_5p.csv']
	...
	execute(csv_files, img_columns, img_finders, 'images')